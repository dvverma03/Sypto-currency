    ...
    return (
      <ScrollView style={{backgroundColor: 'black', flex: 1, paddingBottom: 30}}>
        <View style={{flex: 1, marginTop: 55, marginLeft: 10, marginBottom: 30}}>
          <View>
            <Text style={{fontSize:20, paddingLeft:7, color:'white'}}>Hii {user?.fullName},</Text>
            <Text style={{fontSize:20, paddingLeft:7, color:'white', marginBottom:30}}>Welcome to Sypto currency</Text>
          </View>
          <View>
            <Text
              style={{
